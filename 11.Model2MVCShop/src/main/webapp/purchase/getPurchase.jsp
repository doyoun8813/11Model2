...
<script type="text/javascript">
	$(function() {
		$( "td.ct_btn01:contains('수정')" ).on("click" , function() {
			var tran_no = $(this).attr("data-tranno");
			self.location = "/purchase/updatePurchase?tranNo="+tran_no;
		});
	});
</script>
		...
		<td align="right">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;" data-tranno=${purchase.tranNo}>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
						...
						<a href="#" class="history_back">확인</a>
					</td>
					<td width="14" height="23">
						<img src="/images/ct_btnbg03.gif"width="14" height="23"/>
					</td>
